...
// TODO: Change images somehow or naming
class ProductModelsRepository {
  static const _allProductModels = <ProductModel>[
    ProductModel(
  ...
  static List<ProductModel> loadProductModels(Category category) {
    if (category == Category.all) {
      return _allProductModels;
    } else {
      return _allProductModels.where((p) => p.category == category).toList();
    }
  }
}
